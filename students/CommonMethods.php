...
{	
	...
	var $username = "eburch2";
	var $password = "project2get";
			
	function Common($debug)
	{
		$this->debug = $debug; 
		$rs = $this->connect("eburch2"); // db name really here
		return $rs;
	}
...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
	...
	{
		$conn = @mysql_connect("studentdb.gl.umbc.edu", "eburch2", "project2get") or die("Could not connect to MySQL");
